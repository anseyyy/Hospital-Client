...
function MeetRynott() {
  return (
    <div className="meetrynott-wrapper">
      {/* Hero Section with Background Image */}
      <div className="meetrynott-hero">
        <Container>
          <Row className="justify-content-center text-center">
            <Col lg={10}>
              <span className="pill-label">About Rynott Health</span>
              <h1 className="meetrynott-title">
                A network built around{" "}
                <span>trust, expertise, and compassion.</span>
              </h1>
              <p className="meetrynott-subtitle">
                Rynott Hospitals bring together experienced clinicians,
        ...
        <Row className="justify-content-center mb-5">
          <Col lg={9}>
            <Card className="closing-card">
              ...
              />
              <Card.Body>
                <h3>Why Rynott feels different</h3>
                <p>
                  For Rynott, healthcare is not only about diagnosing and
